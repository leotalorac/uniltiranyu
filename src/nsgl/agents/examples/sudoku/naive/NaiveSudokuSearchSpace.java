 ...
 * @version 1.0
 */
public class NaiveSudokuSearchSpace implements GraphSpace<NaiveSudokuBoardState,Action>{
	...
	@Override
	public OptionCost<NaiveSudokuBoardState,Action> cost() {
		return new OptionCost<NaiveSudokuBoardState,Action>() {		
			@Override
